...
#ifndef CMDLINE_REDUCTION_H
#define CMDLINE_REDUCTION_H
...
#define CMDLINE_PARSER_PACKAGE "reduction"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "reduction"
#endif
...
struct gengetopt_args_info
{
  ...
  char * ifile_arg;	/**< @brief input file (default='samples_matrix.dat').  */
  char * ifile_orig;	/**< @brief input file original value given at command line.  */
  const char *ifile_help; /**< @brief input file help description.  */
  char * ofile_arg;	/**< @brief output file (default='reduced_matrix.dat').  */
