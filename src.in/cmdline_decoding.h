...
#ifndef CMDLINE_DECODING_H
#define CMDLINE_DECODING_H
...
#define CMDLINE_PARSER_PACKAGE "decoding"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "decoding"
#endif
...
struct gengetopt_args_info
{
  ...
  int samples_arg;	/**< @brief number of samples.  */
  char * samples_orig;	/**< @brief number of samples original value given at command line.  */
  const char *samples_help; /**< @brief number of samples help description.  */
  ...
  int tailfactor_arg;	/**< @brief for sampling (default='13').  */
  char * tailfactor_orig;	/**< @brief for sampling original value given at command line.  */
  const char *tailfactor_help; /**< @brief for sampling help description.  */
  int rectangles_arg;	/**< @brief number of rectangles for sampling (default='63').  */
  char * rectangles_orig;	/**< @brief number of rectangles for sampling original value given at command line.  */
  const char *rectangles_help; /**< @brief number of rectangles for sampling help description.  */
  int precision_arg;	/**< @brief for sampling (default='106').  */
  char * precision_orig;	/**< @brief for sampling original value given at command line.  */
  const char *precision_help; /**< @brief for sampling help description.  */
  ...
  int prune_arg;	/**< @brief pruning factor for BKZ reduction (default='0').  */
  char * prune_orig;	/**< @brief pruning factor for BKZ reduction original value given at command line.  */
  const char *prune_help; /**< @brief pruning factor for BKZ reduction help description.  */
  ...
  unsigned int tailfactor_given ;	/**< @brief Whether tailfactor was given.  */
  unsigned int rectangles_given ;	/**< @brief Whether rectangles was given.  */
  ...
  unsigned int prune_given ;	/**< @brief Whether prune was given.  */
