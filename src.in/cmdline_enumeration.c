/*
  ...
  gengetopt -i cmdline_enumeration.ggo -F cmdline_enumeration 
...
const char *gengetopt_args_info_purpose = "Reads a basis from a file and a target vector, runs an enumeration algorithm\non it and outputs the result.";

const char *gengetopt_args_info_usage = "Usage: enumeration [OPTIONS]...";
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ifile_arg = gengetopt_strdup ("samples");
  args_info->ifile_orig = NULL;
  args_info->ofile_arg = gengetopt_strdup ("solution_vector.dat");
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->sigma_help = gengetopt_args_info_help[4] ;
  args_info->beta_help = gengetopt_args_info_help[5] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->ifile_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->ifile_given)
    write_into_file(outfile, "ifile", args_info->ifile_orig, 0);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVn:q:s:b:e:d:pi:o:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'p':	/* run parallel implementations of enumeration algorithms.  */
          ...
          break;
        case 'i':	/* input file prefix, \"_{matrix,vector}.dat\" will be appended..  */
        
        
          if (update_arg( (void *)&(args_info->ifile_arg), 
               &(args_info->ifile_orig), &(args_info->ifile_given),
              &(local_args_info.ifile_given), optarg, 0, "samples", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "ifile", 'i',
              additional_error))
            goto failure;
        ...
        case 'o':	/* output file.  */
          ...
          if (update_arg( (void *)&(args_info->ofile_arg), 
              ...
              &(local_args_info.ofile_given), optarg, 0, "solution_vector.dat", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "ofile", 'o',
              additional_error))
            goto failure;
